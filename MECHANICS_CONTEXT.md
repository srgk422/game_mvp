...
Проект представляет собой мультиплеерный хоррор. Текущий MVP фокусируется на **Этапе 5: Истинное Ядро**.
**Цель:** Игроки должны уничтожить био-механическое Ядро в центре зала, избегая лучей паралича от 5 копий ИИ.
